...
* [`src/breakout/styles.cljs`](src/breakout/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/breakout/`](src/breakout/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/breakout/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `breakout` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/breakout/config.cljs) defaults to `true` in
...
```clj
(ns breakout.example
  (:require [breakout.config :as config])
